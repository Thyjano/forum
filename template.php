          ...
          <div class="card">
              <div class="card-content">
                ...
                <ul class="tabs">
                  ...
                  <li class="tab"><a href="#threads">Threads</a></li>
                  <li class="tab"><a href="#topics">Topics</a></li>
                  <li class="tab"><a href="#replies">Replies</a></li>
                </ul>
              </div>
              <div class="collection">
                  <div id="users" class="collection-item">
                    <h1>Users</h1>
                  </div>
                  <div id="threads" class="collection-item">
                      <h1>Threads</h1>
                  </div>
                  <div id="topics" class="collection-item">
                      <h1>Topics</h1>
                  </div>
                  <div id="replies" class="collection-item">
                      <h1>Replies</h1>
                  </div>
              </div>
            </div>
